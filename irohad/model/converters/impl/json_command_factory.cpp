  ...
  namespace model {
    namespace converters {
      ...
      Document JsonCommandFactory::serializeSubtractAssetQuantity(
        ...
        document.AddMember("part_id", subtract_asset_quantity->part_id, allocator);
        document.AddMember("hash_val", subtract_asset_quantity->hash_val, allocator);
      ...
      JsonCommandFactory::deserializeSubtractAssetQuantity(
        ...
        return make_optional_ptr<SubtractAssetQuantity>()
            ...
            | des.Array(&SubtractAssetQuantity::part_id, "part_id")
            | des.Array(&SubtractAssetQuantity::hash_val, "hash_val") | toCommand;
      }
